...
<body class="bg-blue-50 min-h-screen flex flex-col items-center py-8">
    <div class="w-full max-w-md mx-auto bg-white rounded-xl shadow-lg p-8 border border-gray-200">
        <h1 class="text-xl font-bold text-blue-800 mb-2">บันทึกข้อมูลจุดตรวจตู้</h1>
        ...
        <form method="post" autocomplete="off" class="space-y-4">
            <div>
                <label class="block font-semibold mb-1 text-gray-700">จุดตรวจตู้ (InspectionPoint)</label>
...
document.querySelector('form').addEventListener('submit', function(e) {
    ...
    fetch('save_pickupPoint_ajax.php', {
        method: 'POST',
        body: formData
    })
    .then(r => r.json())
